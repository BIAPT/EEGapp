...
for targ=0:7;
    ...
    [C,phi,S12,S1,S2,t,f,zerosp]=cohgramcpt(datalfp,datasp,movingwin,params); % Note cohgramcpt does give you spectra but not the errors.
    subplot(3,3,fignum(targ+1));imagesc(t,f,C'); axis xy; colorbar;
end;
