function errors = pli_eegapp(EEG,data_length,permutation,p_value,bandpass,custom_order)

%   pli_eegapp  calculate phase lag index.
%   errors = pli_eegapp(EEG,data_length,permutation,p_value) calculate dpli.
%   errors = pli_eegapp(EEG,data_length,permutation,p_value,bandpass)
...
%   Will also print a plot of the pli.
%
%   See also dpli_eegapp.
...
%default is 0 for all bandpass
    ...
    pli_function(EEG,pli_prp,pwd,orderType,newOrder);
